...
//   set: ([val]) => {
//     if (val !== undefined) model.value = val // Update model when array changes
//   }
// })
</script>
...
<template>
  <SliderRoot :class="cn(
    ...
    <SliderTrack
      ...
      <SliderRange class="bg-primary absolute h-full rounded-full data-[orientation=vertical]:w-full" />
    </SliderTrack>
